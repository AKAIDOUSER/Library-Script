    ...
    function solicitarChaveMistral() {
        return new Promise((resolve) => {
            ...
            Object.assign(modalContainer.style, {
                background: 'rgba(26, 27, 30, 0.95)', backdropFilter: 'blur(10px)',
            ...
            title.innerText = '🔑 Configurar API Mistral';
            Object.assign(title.style, {
                margin: '0 0 12px 0', fontSize: '20px', fontWeight: '600'
            });

            const message = document.createElement('p');
            message.innerText = 'Digite sua chave de API do Mistral para continuar. Você pode obter uma em:';
            Object.assign(message.style, {
                margin: '0 0 8px 0', fontSize: '14px', lineHeight: '1.5',
                color: 'rgba(255, 255, 255, 0.8)'
            });

            const link = document.createElement('a');
            link.href = 'https://console.mistral.ai/api-keys/';
            link.target = '_blank';
            link.innerText = 'console.mistral.ai/api-keys/';
            Object.assign(link.style, {
                color: '#8b5cf6', textDecoration: 'underline', fontSize: '14px',
            ...
            Object.assign(input.style, {
                ...
                color: 'white', fontSize: '14px', marginBottom: '16px',
            ...
            btnConfirm.onclick = () => {
                ...
                if (key && key.length > 10) {
                    ...
                    input.placeholder = 'Chave inválida! Tente novamente.';
                }
            };
